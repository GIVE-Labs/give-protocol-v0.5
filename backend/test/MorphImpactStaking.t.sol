...
contract MorphImpactStakingTest is Test {
    ...
    function test_RevertIf_UnsupportedToken() public {
        ...
        staking.stake(ngo1, unsupportedToken, STAKE_AMOUNT, LOCK_PERIOD, YIELD_CONTRIBUTION);
        vm.stopPrank();
    }
    ...
    function test_RevertIf_InvalidNGO() public {
        ...
        staking.stake(invalidNGO, address(token), STAKE_AMOUNT, LOCK_PERIOD, YIELD_CONTRIBUTION);
        vm.stopPrank();
    }
    ...
    function test_RevertIf_InvalidAmount() public {
        ...
        staking.stake(ngo1, address(token), 0, LOCK_PERIOD, YIELD_CONTRIBUTION);
        vm.stopPrank();
    }
