...
contract NGORegistryTest is Test {
    ...
    function test_RegisterNGO() public {
        vm.prank(ngo1);
        registry.registerNGO(NGO_NAME, NGO_DESCRIPTION, NGO_WEBSITE, NGO_LOGO, ngo1, causes, METADATA_HASH);
    ...
    function test_RevertIf_InvalidAddress() public {
        ...
        registry.registerNGO(NGO_NAME, NGO_DESCRIPTION, NGO_WEBSITE, NGO_LOGO, address(0), causes, METADATA_HASH);
    }

    function test_RevertIf_EmptyName() public {
        vm.prank(ngo1);
        vm.expectRevert(NGORegistry.InvalidName.selector);
        registry.registerNGO("", NGO_DESCRIPTION, NGO_WEBSITE, NGO_LOGO, ngo1, causes, METADATA_HASH);
    }
    ...
    function test_RevertIf_EmptyCauses() public {
        ...
        registry.registerNGO(NGO_NAME, NGO_DESCRIPTION, NGO_WEBSITE, NGO_LOGO, ngo1, emptyCauses, METADATA_HASH);
    }
    ...
    function test_UpdateNGOInfo() public {
        ...
        vm.prank(ngo1);
        registry.updateNGOInfo(ngo1, newName, newDescription, newWebsite, newLogo, newCauses, newMetadata);
    ...
    function test_RevertIf_UpdateNotAuthorized() public {
        ...
        registry.updateNGOInfo(
            ngo1, "Updated", "Updated", "https://updated.org", "ipfs://updated", causes, METADATA_HASH
        );
    }
    ...
    function test_FlagCauseDeviation() public {
        ...
        (bool isFlagged, string memory reason, uint256 timestamp, address reporter) = registry.getCauseDeviation(ngo1);
    ...
    function test_GetAllNGOs() public {
        vm.prank(ngo1);
        registry.registerNGO("NGO 1", "Description 1", "https://ngo1.org", "ipfs://logo1", ngo1, causes, METADATA_HASH);

        vm.prank(ngo2);
        registry.registerNGO("NGO 2", "Description 2", "https://ngo2.org", "ipfs://logo2", ngo2, causes, METADATA_HASH);
    ...
    function test_GetNGOsByVerification() public {
        vm.prank(ngo1);
        registry.registerNGO("NGO 1", NGO_DESCRIPTION, NGO_WEBSITE, NGO_LOGO, ngo1, causes, METADATA_HASH);

        vm.prank(ngo2);
        registry.registerNGO("NGO 2", NGO_DESCRIPTION, NGO_WEBSITE, NGO_LOGO, ngo2, causes, METADATA_HASH);
