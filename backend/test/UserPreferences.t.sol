...
contract UserPreferencesTest is Test {
    ...
    function testUserPreferenceWorkflow() public {
        ...
        assertEq(usdc.balanceOf(feeRecipient) - treasuryBefore, user1ToTreasury, "Treasury should receive user1's remainder");
        assertEq(usdc.balanceOf(protocolTreasury) - protocolBefore, user1ProtocolFee + user2ProtocolFee, "Protocol should receive fees");
    }
