...
contract YieldDistributorTest is Test {
    ...
    function setUp() public {
        ...
        registry.registerNGO(
            "NGO 1", "Description 1", "https://ngo1.org", "ipfs://logo1", ngo1, causes, "ipfs://metadata1"
        );
        vm.stopPrank();

        vm.startPrank(ngo2);
        registry.registerNGO(
            "NGO 2", "Description 2", "https://ngo2.org", "ipfs://logo2", ngo2, causes, "ipfs://metadata2"
        );
        vm.stopPrank();
    ...
    function test_GetDistributionStatus() public {
        (bool canDistribute, uint256 timeUntil, uint256 totalTokens) = distributor.getDistributionStatus();
    ...
    function test_ComplexDistributionScenario() public {
        ...
        // Verify distribution
        (uint256 roundNumber, uint256 totalYield,, uint256 stakersCount) = distributor.getDistributionRound(1);
    ...
    function test_DistributionWithUnverifiedNGO() public {
        ...
        vm.startPrank(ngo3);
        registry.registerNGO(
            "NGO 3", "Description 3", "https://ngo3.org", "ipfs://logo3", ngo3, causes, "ipfs://metadata3"
        );
        vm.stopPrank();
    ...
    function test_MultipleDistributionRounds() public {
        ...
        (uint256 round1Number, uint256 totalYield1,,) = distributor.getDistributionRound(1);
        (uint256 round2Number, uint256 totalYield2,,) = distributor.getDistributionRound(2);
